...
import com.miportfolio.Agustin.Dto.dtoHys;
import com.miportfolio.Agustin.Entity.hys;
import com.miportfolio.Agustin.Security.Controller.Mensaje;
import com.miportfolio.Agustin.Service.Shys;
...
public class CHys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        ...
        shys.save(hYs);
        return new ResponseEntity(new Mensaje("Skill creado correctamente"), HttpStatus.OK);
    }
